...
describe('hashMessage', () => {
  describe('ETH_SIGN', () => {
    ...
    test('should hash message', () => {
      expect(
        hashMessage({
          messageType: EUnsignedMessageTypeEvm.ETH_SIGN,
          message,
        }),
      ).toMatchSnapshot();
    });
  ...
  describe('PERSONAL_SIGN', () => {
    ...
    test('should hash message', () => {
      expect(
        hashMessage({
          messageType: EUnsignedMessageTypeEvm.PERSONAL_SIGN,
          message,
        }),
      ).toMatchSnapshot();
    });
  ...
  describe('TYPE_DATA_V3', () => {
    test('should hash a minimal valid typed message', () => {
      const hash = hashMessage({
        messageType: EUnsignedMessageTypeEvm.TYPE_DATA_V3,
        message: {
          types: {
            EIP712Domain: [],
          },
  ...
  describe('TYPE_DATA_V4', () => {
    test('should hash a minimal valid typed message', () => {
      const hash = hashMessage({
        messageType: EUnsignedMessageTypeEvm.TYPE_DATA_V4,
        message: {
          types: {
            EIP712Domain: [],
          },
